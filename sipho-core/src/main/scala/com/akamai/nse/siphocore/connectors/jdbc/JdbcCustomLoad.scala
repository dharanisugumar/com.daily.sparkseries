...
import com.akamai.nse.siphocore.common.{Encryption, JsonUtil, TaskStageEnum, TaskStatusEnum}
 ...
 */
  ...
  */
  appContext.jobLogger.eventLog(LogLevelEnum.INFO, appContext.job, LogMessage(appContext.logIdentifier, " ", EventTypeEnum.TASK, TaskStageEnum.PreProcessor, " Decrypting the password ", TaskStatusEnum.STARTED, "", ""))

  val key = "key"
//  println("password ",password)
  val decryptedPwd = Encryption.decrypt("password",password)
//  println("decryptedPwd "+ decryptedPwd)
  appContext.jobLogger.eventLog(LogLevelEnum.INFO, appContext.job, LogMessage(appContext.logIdentifier, " ", EventTypeEnum.TASK, TaskStageEnum.PreProcessor, " Decrypting the password ", TaskStatusEnum.FINISHED, "", ""))
